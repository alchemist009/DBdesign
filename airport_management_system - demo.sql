...
--
-- Host: 127.0.0.1:8889
-- Generation Time: Apr 26, 2017 at 04:06 PM
...
--
ALTER TABLE `controls`
  ADD CONSTRAINT `F_code_FK` FOREIGN KEY (`F_Code`) REFERENCES `flight_instance` (`Flight_code`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `flight`
  ADD CONSTRAINT `C_ID_FK` FOREIGN KEY (`C_ID`) REFERENCES `airline` (`Carrier_ID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `flight_instance`
--
ALTER TABLE `flight_instance`
  ADD CONSTRAINT `Fl_no_FK` FOREIGN KEY (`Fl_no`) REFERENCES `flight` (`Flight_no`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `T_ID_FK2` FOREIGN KEY (`T_ID`) REFERENCES `atc` (`Tower_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `fl_generates`
--
ALTER TABLE `fl_generates`
  ADD CONSTRAINT `F_code_FK2` FOREIGN KEY (`F_Code`) REFERENCES `flight_instance` (`Flight_code`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `operational_days`
  ADD CONSTRAINT `Flight_num_PK` FOREIGN KEY (`Flight_num`) REFERENCES `flight` (`Flight_no`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `resource1`
--
ALTER TABLE `resource1`
  ADD CONSTRAINT `Fl_Code_FK` FOREIGN KEY (`Fl_code`) REFERENCES `flight_instance` (`Flight_code`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `resource2`
--
ALTER TABLE `resource2`
  ADD CONSTRAINT `Fl_Code_FK2` FOREIGN KEY (`Fl_code`) REFERENCES `flight_instance` (`Flight_code`) ON DELETE CASCADE ON UPDATE CASCADE;
